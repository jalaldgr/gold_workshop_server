...
const schema = new Schema({
    ...
    table2:{type:String,default:`{"row":[1,2,3],"description":["مانده روز قبل","کسر برش","کسر ذوب"],"import":[0,0,0],"export":[0,0,0],"final_balance":[0,0,0],"real_balance":[0,0,0],"balance":[0,0,0],"difference":[0,0,0]}`},
